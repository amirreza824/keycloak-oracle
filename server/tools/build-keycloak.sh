...
mkdir -p /opt/jboss/keycloak/modules/system/layers/base/com/oracle/ojdbc8/main
cp /opt/jboss/tools/orcl/ojdbc8.jar /opt/jboss/tools/orcl/module.xml /opt/jboss/keycloak/modules/system/layers/base/com/oracle/ojdbc8/main
